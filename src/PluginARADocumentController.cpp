...
//==============================================================================
juce::ARAPlaybackRenderer* SaigonDocumentController::doCreatePlaybackRenderer() noexcept
{
    return new SaigonPlaybackRenderer (getDocumentController());
}

//==============================================================================
bool SaigonDocumentController::doRestoreObjectsFromStream (juce::ARAInputStream& input, const juce::ARARestoreObjectsFilter* filter) noexcept
{
...
bool SaigonDocumentController::doStoreObjectsToStream (juce::ARAOutputStream& output, const juce::ARAStoreObjectsFilter* filter) noexcept
{
...
{
    return juce::ARADocumentControllerSpecialisation::createARAFactory<SaigonDocumentController>();
}
